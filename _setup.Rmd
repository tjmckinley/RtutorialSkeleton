...
knit_engines$set(task = function(options) {
    if(options$renderTask) {
        ...
        if(opts_knit$get("rmarkdown.pandoc.to") != "latex") {
            out <- paste0("<div class=\"panel panel-default\">\n<div class=\"panel-heading\">", headerName, "</div>\n<div class=\"panel-body\">", out, "</div>\n</div>")
        } else {
...
knit_engines$set(solution = function(options) {
    if(options$renderSol) {
        if(!options$multCode) {
            ...
            if(opts_knit$get("rmarkdown.pandoc.to") != "latex") {
                out <- paste0("<div class=\"tab\">\n<button class=\"tablinks", options$label, " active\" onclick=\"javascript:openCode(event, 'option1", options$label, "', '", options$label, "');\">", headerNames[1], "</button><button class=\"tablinks", options$label, "\" onclick=\"javascript:openCode(event, 'option2", options$label, "', '", options$label, "');\">", headerNames[2], "\n</button>\n</div>\n<div id=\"option1", options$label, "\" class=\"tabcontent", options$label, "\">", out[[1]], "\n</div>\n<div id=\"option2", options$label, "\" class=\"tabcontent", options$label, "\">", out[[2]], "\n</div><script> javascript:hide('option2", options$label, "') </script>")
                out <- paste0("<button id=\"displayText", options$label, "\" onclick=\"javascript:toggle('", options$label, "');\">Show: ", headerName, "</button>\n\n<div id=\"toggleText", options$label, "\" style=\"display: none\">\n<div class=\"panel panel-default\">\n<div class=\"panel-heading panel-heading1\"> ", headerName, "\n</div>\n<div class=\"panel-body\">", out, "\n</div>\n</div>\n</div>\n")
                return(out)
            } else {
        ...
        if(opts_knit$get("rmarkdown.pandoc.to") != "latex") {
            if(options$collapsible) {
                ...
                if(!is.na(headerName)) {
                    ...
                    out <- paste("<div class=\"panel panel-default\">\n<div class=\"panel-heading panel-heading2\">", headerName, "</div>\n<div class=\"panel-body\">", out, "\n</div>\n</div>")
                } else {
                    ## set up standard boxed environment
                    out <- paste("<div class=\"panel panel-default\">\n<div class=\"panel-body\">", out, "\n</div>\n</div>\n")
                }
...
knit_engines$set(hypertarget = function(options) {
    ...
    if(opts_knit$get("rmarkdown.pandoc.to") != "latex") {
        ...
        out <- paste0("\\phantomsection\\label{", options$label, "}\n")
    }
    return(out)
})
